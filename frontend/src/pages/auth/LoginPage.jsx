...
const LoginPage = () => {
  ...
  return (
    <AuthLayout 
      quote="The real-time collaboration features in CollabDocs have transformed how our engineering team builds documentation."
      author="Sarah Chen, Lead at TechFlow"
    >
      <div className="space-y-8">
        {/* Header */}
        <div className="space-y-2">
          <h1 className="text-3xl font-medium text-[#fafafa] tracking-tight">Welcome Back</h1>
          <p className="text-[#898989] text-[15px]">Sign in to your CollabDocs account.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center ml-1">
              <Label htmlFor="password" className="text-[11px] font-bold text-[#4d4d4d] uppercase tracking-[1.5px]">Password</Label>
              <Link to="/forgot-password" title="Forgot Password" className="text-[11px] font-bold text-[#3ecf8e] hover:text-[#00c573] uppercase tracking-wider transition-colors">Recovery</Link>
            </div>
            <div className="relative group">
        ...
        <p className="text-[#4d4d4d] text-[13px] text-center pt-4">
          ...
          <Link to="/signup" className="text-[#fafafa] hover:text-[#3ecf8e] font-medium transition-colors cursor-pointer ml-1">
            Create an account
          </Link>
        </p>

        <div className="pt-8 text-center">
           <p className="text-[11px] text-[#4d4d4d] leading-relaxed max-w-[320px] mx-auto">
             By clicking continue, you agree to our <span className="text-[#898989] underline cursor-pointer hover:text-[#fafafa]">Terms of Service</span> and <span className="text-[#898989] underline cursor-pointer hover:text-[#fafafa]">Privacy Policy</span>.
           </p>
        </div>
      </div>
    </AuthLayout>

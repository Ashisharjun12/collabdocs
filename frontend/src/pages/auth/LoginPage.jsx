...
import { Mail, Lock, LogIn, Layout, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="w-full max-w-md bg-[#13151f]/80 backdrop-blur-xl border border-[#1e2130] rounded-2xl shadow-2xl overflow-hidden animate-in fade-in duration-500">
        ...
        <div className="p-8">
          ...
          <div className="flex items-center gap-4 my-8">
            ...
            <span className="text-slate-500 text-[10px] font-bold uppercase tracking-widest">or sign in with email</span>
            <div className="h-[1px] bg-[#1e2130] flex-1"></div>
          </div>

          {/* Verification Success Message */}
          {new URLSearchParams(window.location.search).get('verified') === 'true' && (
            <div className="mb-6 p-3 bg-[#1D9E75]/10 border border-[#1D9E75]/30 rounded-xl text-center">
              <p className="text-[#1D9E75] text-sm font-medium">Email verified successfully! You can now sign in.</p>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center ml-1">
                ...
                <Link to="/forgot-password" title="Forgot Password" className="text-[11px] text-[#1D9E75] hover:text-[#168a65] transition-colors">Forgot?</Link>
              </div>
              <div className="relative group">
          ...
          <p className="text-center mt-8 text-slate-400 text-sm">
            ...
            <Link to="/signup" className="text-[#1D9E75] hover:text-[#168a65] font-semibold transition-colors cursor-pointer">
              Create one
            </Link>
          </p>
        </div>
